...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_todo_data_service__WEBPACK_IMPORTED_MODULE_2__["TodoDataService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var TodoDataService = /** @class */ (function () {
    ...
    TodoDataService.prototype.DeleteTodosbyId = function (id) {
        this.todos = this.todos.filter(function (todo) { return todo.id !== id; });
        return this;
    };
    TodoDataService.prototype.UpdateTodosById = function (id, values) {
        if (values === void 0) { values = {}; }
        var todo = this.getTodosById(id);
        if (!todo) {
            return null;
        }
    ...
    TodoDataService.prototype.getAllTodo = function () {
        return this.todos;
    };
    TodoDataService.prototype.getTodosById = function (id) {
        return this.todos.filter(function (todo) { return todo.id !== id; }).pop();
    };
    TodoDataService.prototype.toggleTodoComplete = function (todo) {
        var updateTodo = this.UpdateTodosById(todo.id, {
...
module.exports = __webpack_require__(/*! D:\TODO APP\TODOAPP\src\main.ts */"./src/main.ts");
